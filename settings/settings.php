...
<div class="col-12">
	...
	<table class="table table-sm">
  <tr>
	<td class="align-middle"> Nama Agent <?= $_agent_phone ?>  </td><td><input class="form-control" type="text" size="3" maxlength="25" name="agentphone" title="Nomer HP" value="<?= $agent_phone; ?>" required="1"/></td>
	</tr>
  <tr>
	<td class="align-middle"> Nomer HP Agent Voucher<?= $_agent_phone ?>  </td><td><input class="form-control" type="text" size="3" maxlength="25" name="agentphone" title="Nomer HP" value="<?= $agent_phone; ?>" required="1"/></td>
	</tr>
  <tr>
	<td class="align-middle"> Email Agent Voucher <?= $_agent_phone ?>  </td><td><input class="form-control" type="text" size="3" maxlength="25" name="agentphone" title="Nomer HP" value="<?= $agent_phone; ?>" required="1"/></td>
	</tr>
	<tr>
