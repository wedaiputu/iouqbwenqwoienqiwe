...
if ($currency == in_array($currency, $cekindo['indo'])) {
	$title = array("Status Voucher", "User/Kode ", "Paket", "Lama Terhubung", "Pemakaian Data", "Sisa Data", "Masa Aktif", "Dari", "Sampai", "tidak terdaftar.", "sudah kadaluarsa.", "Tanggal", "Cek Status", " Hari", " Jam", "Aktif", "Expired");
} else {
...
<link rel="icon" href="../img/logoJinom.png" />
<script>
function goBack() {
    window.history.back();
}
