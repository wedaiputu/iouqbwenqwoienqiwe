  ...
  <div class="card">
    ...
    <div class="card-body">
      ...
      <table class="table" style="width:90%">
        ...
        <tr>
          <td class="align-middle text-center">
            <input style="width: 100%; margin-top:20px; height: 35px; font-weight: bold; font-size: 17px;" class="btn-login background-color: #00CC69;" type="submit" name="login" value="Login">
          </td>
        </tr>
        <tr>
          <td class="align-middle text-center">
